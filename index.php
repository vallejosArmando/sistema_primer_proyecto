...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="login/index.php">SISTEMA WEB:</a>
          ...
          <i class="fas fa-bars"></i>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#about">Acerca de Cosaalt.</a>
                    </li>
                    <li class="nav-item">
    ...
    <header class="masthead">
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Vien venidos al </div>
                <div class="intro-heading text-uppercase">SISTEMA DE RECLAMOS PARA LOS USUARIOS DE TARIJA</div>
            ...
            <div class="row text-center">
              ...
              <i class="fas fa-shopping-cart fa-stack-1x fa-inverse"></i>
                    ...
                    <h4 class="service-heading">
                        Mantenimiento de la red de distribucion de agua potable</h4>
              ...
              <i class="fas fa-laptop fa-stack-1x fa-inverse"></i>
                    ...
                    <h4 class="service-heading">Mantenimiento de la red matriz de alcantarillado sanitario</h4>
                    <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
              ...
              <i class="fas fa-lock fa-stack-1x fa-inverse"></i>
                    ...
                    <h4 class="service-heading">
                        Mantenimiento y limpieza de los depositos de agua potable</h4>
                    <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        <h4>Hilos</h4>
                        <p class="text-muted">Ilustracion</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        <h4>Terminar</h4>
                        <p class="text-muted">Identidad</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        <h4>
                            Sur oeste</h4>
                        <p class="text-muted">Diseño de páginas web</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        <h4>Ventana</h4>
                        <p class="text-muted">Fotografìa</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="timeline">
                        <li>
                            <div class="timeline-image">
                                <img class="rounded-circle img-fluid" src="img/about/cosaalt.jpg" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>2009-2011</h4>
                                    <h4 class="subheading">
                                        2009-2011 Nuestros humildes Comienzos</h4>
                                </div>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="rounded-circle img-fluid" src="img/about/foto1.jpg" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>March 2011</h4>
                        ...
                        <li>
                            <div class="timeline-image">
                                <img class="rounded-circle img-fluid" src="img/about/fot2.jpg" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>December 2012</h4>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="rounded-circle img-fluid" src="img/about/fot3.jpeg" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>July 2014</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input class="form-control" id="name" type="text" placeholder="nombre y apellido *" required="required" data-validation-required-message="Please enter your name.">
