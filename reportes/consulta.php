...
<tbody>
    ...
    <?php 
    $v=mysqli_query($con," SELECT * FROM areas where fec_insercion BETWEEN '$f1' AND '$f2' ");
    while ($areas=mysqli_fetch_array($v)){
   ...
   <div class=" ff "> DE: <?php echo $f1 ?> -- Al: <?php echo $f2 ?></div> 
<br>
