...
<div class="container">
    <div class="row">
        ...
        <div class="jumbotron">
          ...
          <h2 class="text-center">Usuario: <span class="badge badge-success"><?php echo $_SESSION["nom_usuario"];?></span></h2>    
          <p class="lead text-center">Usted NO tiene permisos de ADMINISTRADOR</p>          
          <h2 class="text-center">Su permiso es: <span class="badge badge-warning"><?php echo $_SESSION["id_Rol"];?></span></h2>  
          <hr class="my-4">          
