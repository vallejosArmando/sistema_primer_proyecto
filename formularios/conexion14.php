...
$sql="INSERT INTO reclamo_confirmados VALUES(null,1,'$nombres','$ap','$am','$telefono','$correo','$codigo_usuario','$barrio','$calle_avenida','$entre_que_calles','$numero_de_casa','$referencias','$descripcion_del_reclamo','$destino','$map','$otro_recurrente','$telefono_del_recurrente','$tipo_de_calzada',now(),now(),1,1)";
...
if (!$ejec) {
    ...
    echo " <br><a href='reclamo_confirmados.php'>Volver</a>'";
